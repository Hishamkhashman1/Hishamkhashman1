...
- [**Rick and Morty API**](https://github.com/Hishamkhashman1/rick-and-morty-API) – Custom REST API built with FastAPI, featuring filtering, pagination, and scalable backend structure  
